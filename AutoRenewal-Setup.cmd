...
set "line============================================================="
color 07
if %Unattend% EQU 0 title Auto Renewal Setup
if %Silent% EQU 0 if %_Debug% EQU 0 mode con cols=98 lines=28
...
if exist %_Hook% (
dir /b /al %_Hook% %_Nul3% || goto :remv
)
...
if %SSppHook% NEQ 0 if not exist %w7inf% (
  echo.
  echo Adding migration fail-safe...
  echo %w7inf%
...
echo Verify that Antivirus protection is OFF or the folder path is excluded.
goto :TheEnd
